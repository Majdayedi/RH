      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <div class="header-icons">
            ...
            <a href="{{ route('admin') }}" class="account"><i class="fas fa-user"></i>  Manage companies</a>
...
<div class="hero-features mb-4">
        ...
        <i class="fas fa-building me-2"></i> List Your Company
         ...
         <button id="scrollToCompanies" class="btn btn-outline-light btn-lg">
...
@media (max-width: 768px) {
  ...
  <!-- JavaScript -->
   <script>
document.getElementById('scrollToCompanies').addEventListener('click', function() {
